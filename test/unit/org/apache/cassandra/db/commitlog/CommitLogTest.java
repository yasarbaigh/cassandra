...
public abstract class CommitLogTest
{
    ...
    public void testCompletedTasks() throws Exception {
        ...
        assertTrue("Even after mutations totalCommitLogSizec not updated.", latestCompletedTasks > initialCompletedTasks);
    }
    ...
    public void testWaitingOnCommit() throws Exception {
        ...
        assertTrue("After mutations sync waitingOnCommit metric updated.", latestCount > initialCount);
    }
}
